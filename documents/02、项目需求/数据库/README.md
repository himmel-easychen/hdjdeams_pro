...
- `zo_eams.sql`：脚本包含建库、建表语句，<b style="color:red">必须执行</b>
- `zo_eams_init*.sql`：脚本定义系统初始化必须要创建的数据，<b style="color:red">必须执行</b>
- `zo_eams_test*.sql`：脚本定义开发测试数据，<b style="color:blue">可选执行</b>
