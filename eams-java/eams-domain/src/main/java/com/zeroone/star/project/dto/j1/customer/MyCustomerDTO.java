package com.zeroone.star.project.dto.j1.customer;
...
public class MyCustomerDTO {
     ...
     * 销售顾问 ID
     */
    @ApiModelProperty(value = "销售顾问 ID", example = "1001")
     ...
     * 客户邮箱
     */
    @ApiModelProperty(value = "客户邮箱", example = "lisi@example.com")
     ...
     * 备注
     */
    @ApiModelProperty(value = "备注", example = "客户比较关注就业服务")
