...
class StudentFileDTO : public oatpp::DTO
{
	DTO_INIT(StudentFileDTO, DTO);
...
class StudentFilePageDTO : public PageDTO<StudentFileDTO::Wrapper>
{
	DTO_INIT(StudentFilePageDTO, PageDTO<StudentFileDTO::Wrapper>);
};

class StudentFileProDTO : public oatpp::DTO
{
	DTO_INIT(StudentFileProDTO, DTO);
	DTO_FIELD(String, mobile);
	DTO_FIELD_INFO(mobile) {
...
class StudentTimeTableDTO : public oatpp::DTO
{
	DTO_INIT(StudentTimeTableDTO, DTO);
...
class StudentTimeTablePageDTO : public PageDTO<StudentTimeTableDTO::Wrapper>
{
	DTO_INIT(StudentTimeTablePageDTO, PageDTO<StudentTimeTableDTO::Wrapper>);
};
