...
public:
	...
	// 3.2 定义新增接口处理
	API_HANDLER_ENDPOINT_AUTH(API_M_POST, "/c7-workbench/FreeCoursesArrange", addFreeCoursesArrange, BODY_DTO(freeCoursesArrangeDTO::Wrapper, dto), execAddSample(dto, authObject->getPayload()));
