...
class ReviewHomeworkFormDTO : public oatpp::DTO
{
    ...
    API_DTO_FIELD_REQUIRE(UInt64, recordId, ZH_WORDS_GETTER("homework.field.record-id"), true);
...
class HomeworkRecordDTO : public oatpp::DTO
{
    ...
    API_DTO_FIELD_DEFAULT(UInt64, id, ZH_WORDS_GETTER("homework.field.record-id"));
    API_DTO_FIELD_DEFAULT(UInt64, homeworkId, ZH_WORDS_GETTER("homework.field.id"));
    ...
    API_DTO_FIELD_DEFAULT(Int64, teacherId, ZH_WORDS_GETTER("homework.field.teacher-id"));
...
class ReviewResultDTO : public oatpp::DTO
{
    ...
    API_DTO_FIELD_DEFAULT(UInt64, recordId, ZH_WORDS_GETTER("homework.field.record-id"));
};
