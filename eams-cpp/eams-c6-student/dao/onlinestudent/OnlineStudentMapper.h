...
#ifndef _ONLINESTUDENT_MAPPER_
#define _ONLINESTUDENT_MAPPER_
...
class OnlineExportMapper : public Mapper<StudentDetail> {
...
class PtrOnlineExportMapper : public Mapper<PtrStudentDetail>
{
public:
